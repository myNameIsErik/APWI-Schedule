                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="/add-mapel" class="active"> <i class="icon-note menu-icon"></i>Tambah Mapel
                                </a>
                            </li>
                        </ul>
                    </li>
            ...
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Tambah Mapel</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="#" method="post">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-username">Kode Mapel <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="" name="val-username" placeholder="Masukan Kode Mapel..">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-email">Nama Mapel <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-email" name="val-email" placeholder="Masukan Nama Mapel..">
                                            </div>
                                        </div>
                                        <div class="form-group row">
