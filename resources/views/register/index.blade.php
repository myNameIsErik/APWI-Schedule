                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                    ...
                                    <a class="text-center"> <h4>Registration Form</h4></a>
        
                                <form action="/register" method="post" class="mt-5 mb-5 login-input">
                                    @csrf
                                    <div class="form-group">
                                        <input type="text" class="form-control @error('nip') is-invalid @enderror" name="nip" id="nip"  placeholder="NIP.." required value="{{ old('nip') }}">
                                        @error('nip')
